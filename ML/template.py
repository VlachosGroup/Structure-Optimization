...
class dyno_struc(object):
    ...
    def __init__(self):
        ...
        self.occupancies = []               # occupancies of atoms in the ASE atoms object
        self.atoms_defected = []            # ASE atoms object, with some atoms removed or transmuted
        
        self.KMC_lat = []                   # KMC lattice object
        self.lat_graph = []                 # networkx graph object
        
        self.fingerprint_graphs = []        # networkx graph object, subgraphs to
